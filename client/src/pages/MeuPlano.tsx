  ...
  const planos = [
    {
      ...
      atual: user.subscriptionPlan === "pf_free",
    },
    {
      id: "pf-premium",
      nome: "PF Premium",
      ...
      atual: user.subscriptionPlan === "pf_premium",
      destaque: true,
    },
    {
      id: "pj-test",
      ...
      atual: user.subscriptionPlan === "pj_test",
    },
    {
      id: "pj-premium",
      nome: "PJ Premium",
      ...
      atual: user.subscriptionPlan === "pj_premium",
      destaque: true,
    },
  ];
            ...
            <CardContent>
              <div className="grid md:grid-cols-3 gap-6">
                ...
                <div>
                  ...
                  <p className="text-3xl font-bold text-white">{user.maxProducts}</p>
                </div>
                <div>
                  <p className="text-slate-400 mb-2">Limite de Demandas</p>
                  <p className="text-3xl font-bold text-white">{user.maxDemands}</p>
                </div>
              </div>
            </CardContent>
          </Card>
